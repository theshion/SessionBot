...
#Tokens
BOT_TOKEN = os.getenv("BOT_TOKEN", "7939164806:AAGjMZ1M_PCvg5elARhk2AOk9sa6nWd4kyo") # get it from @BotFather on telegram by creating a new bot and fill here that bot token.
...
#Owner
LOGGER_ID = int(os.getenv("LOGGER_ID", "7050270303")) # get it by creating a logs group on telegram.
